...
class AnamneseEducacaoFisicaPage extends StatefulWidget {
  const AnamneseEducacaoFisicaPage({super.key});

  @override
  State<AnamneseEducacaoFisicaPage> createState() => _AnamneseEducacaoFisicaPageState();
}

class _AnamneseEducacaoFisicaPageState extends State<AnamneseEducacaoFisicaPage> {
